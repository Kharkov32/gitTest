...
var tabs = (0, _bling.$$)(".tablinks");

var handleClick = function handleClick(e) {
  e.preventDefault();
  (0, _bling.$)(".active").classList.remove("active");
  e.target.classList.add("active");
  var toOpen = e.target.getAttribute("data-open");
  (0, _bling.$)(".open").classList.remove("open");
  (0, _bling.$)("." + toOpen).classList.add("open");
};
...
function removeTabs() {
  tabs.forEach(function (t) {
    return t.addEventListener("click", handleClick);
  });
  if ((0, _bling.$)(".open")) {
    if ((0, _bling.$)(".open")) (0, _bling.$)(".open").classList.remove("open");
    document.querySelectorAll(".tablinks").forEach(function (tl) {
      return tl.style.display = "none";
    });
    document.querySelectorAll(".tabcontent").forEach(function (tl) {
      return tl.style.display = "block";
    });
  }
}

function addTabs() {
  var active = (0, _bling.$)(".active");
  var toOpen = void 0;
  if (!active) toOpen = "description";else toOpen = active.getAttribute("data-open");
  (0, _bling.$)("." + toOpen).classList.add("open");
  (0, _bling.$)(".open").display = "none";
